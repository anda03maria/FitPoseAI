...
IMAGES_DIR = '../data_raw/Squat/Squat/Unlabeled_Dataset/videos/videos'  # sau schimbă dacă ai pus alt nume
OUTPUT_CORRECT = 'data/squat/correct'
OUTPUT_INCORRECT = 'data/squat/incorrect'
...
error_files = [
    'data_raw\Squat\Squat\Labeled_Dataset\Labels\error_knees_forward.json',
    'data_raw\Squat\Squat\Labeled_Dataset\Labels\error_knees_inward.json'
]
